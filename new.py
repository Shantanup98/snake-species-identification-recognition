...
# Label mapping
with open('D:\snake_class.json', 'r') as f:
...
##                                           5    snake_class[class_names[labels[rand_idx].item()]]))
##
...
hidden_layers = None #[512, 256, 128] #[4096, 1024, 256]  #
...
print("Test accuracy: {:.3f}".format(accuracy/len(dataloaders['validate'])))
